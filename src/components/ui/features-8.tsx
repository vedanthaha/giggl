            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-[#111111]/40 border-white/10 text-white">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">Private</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-[#111111]/40 border-white/10 text-white">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                    <svg className="m-auto h-fit w-24" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        />
                                        <path className="text-primary" d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                                        <defs>
                                            <linearGradient id="paint0_linear_0_1" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                                                <stop stopColor="white" stopOpacity="0" />
                                                <stop className="text-primary" offset="1" stopColor="currentColor" />
                                            </linearGradient>
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-gray-400">Every message, call, and file is end-to-end encrypted. We have zero metadata retention, leaving no digital footprint.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-[#111111]/40 border-white/10 text-white">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="text-white/20 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="386" height="123" rx="10" />
                                        <circle className="text-white/40" cx="29" cy="29" r="15" fill="currentColor" />
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-primary/30" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition text-white">Infinite Circles</h2>
                                    <p className="text-gray-400">Create hidden enclaves for your tightest groups. Invitation only, always.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-[#111111]/40 border-white/10 text-white">
                            <CardContent className="grid pt-6 sm:grid-cols-2 h-full">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6 h-full">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white transition">Raw Fidelity</h2>
                                        <p className="text-gray-400">Lossless audio and high-bitrate media sharing, completely secured.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-2xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/10 p-6 py-6 sm:ml-6">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                        <span className="block size-2 rounded-full border border-white/10 bg-white/10"></span>
                                    </div>
                                    <svg className="w-full sm:w-[150%] text-white/20" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-[#111111]/40 border-white/10 text-white">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6 h-full">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                        <Users className="m-auto size-6 text-white" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition text-white">Your Digital Sanctuary</h2>
                                        <p className="text-gray-400">Connect intimately without compromise. Your world stays yours.</p>
                                    </div>
                                </div>
                                <div className="before:bg-white/10 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 px-2 py-1 text-xs shadow-sm bg-black text-gray-300">Likeur</span>
                                            <div className="ring-background size-7 ring-4 rounded-full overflow-hidden">
                                                <img className="size-full object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop" alt="" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4 rounded-full overflow-hidden">
                                                <img className="size-full object-cover" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop" alt="" />
                                            </div>
                                            <span className="block h-fit rounded border border-white/10 px-2 py-1 text-xs shadow-sm bg-black text-gray-300">M. Irung</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 px-2 py-1 text-xs shadow-sm bg-black text-gray-300">B. Ng</span>
                                            <div className="ring-background size-7 ring-4 rounded-full overflow-hidden">
                                                <img className="size-full object-cover" src="https://images.unsplash.com/photo-1517841905240-472988babdf9?w=100&h=100&fit=crop" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
