...
export default function GlowHorizonFM({ className, variant = "top" }: GlowHorizonProps) {
  ...
  return (
    ...
    >
      <Arc variant={variant} color="#444444" size="132%" boxShadow="0px -4px 23px 0px #444444b5" delay={1.2} />
      <Arc variant={variant} color="#222222" size="120%" initialOffset="10%" blur={31} delay={0.6} />
      <Arc variant={variant} color="#151515" size="124%" initialOffset="10%" blur={21} delay={0}   />
